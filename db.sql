...
('Who wrote "To Kill a Mockingbird"?', 'Harper Lee', 'J.K. Rowling', 'George Orwell', 'Mark Twain', 'Harper Lee'),
...
('What is the powerhouse of the cell?', 'Mitochondria', 'Nucleus', 'Ribosome', 'Golgi Apparatus', 'Mitochondria'),
...
('What is the primary ingredient in guacamole?', 'Avocado', 'Tomato', 'Onion', 'Lime', 'Avocado'),
('What is the currency of Japan?', 'Yen', 'Dollar', 'Euro', 'Pound', 'Yen'),
('Who discovered penicillin?', 'Alexander Fleming', 'Marie Curie', 'Isaac Newton', 'Louis Pasteur', 'Alexander Fleming'),
...
('What is the hardest natural substance on Earth?', 'Diamond', 'Graphite', 'Quartz', 'Topaz', 'Diamond'),
('Which country is known as the Land of the Rising Sun?', 'Japan', 'China', 'South Korea', 'Vietnam', 'Japan'),
...
INSERT INTO users (username, password, is_admin,id) VALUES ('admin', 'adminpass123', 1,0);

INSERT INTO users (username, password, role, is_admin,id) VALUES
('student1', 'password1', 'student', 0,1),
('student2', 'password2', 'student', 0,2),
('student3', 'password3', 'student', 0,3),
('student4', 'password4', 'student', 0,4),
('student5', 'password5', 'student', 0,5),
('student6', 'password6', 'student', 0,6),
